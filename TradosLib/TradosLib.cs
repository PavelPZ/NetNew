...
namespace TradosDT {
  ...
  public partial class Sentence {
    ...
    public static Sentence insert(TradosDB db, Page page, string name, string srcText, Langs srcLang, string transText, Langs transLang) {
      var sent = insert(db, name, srcText, srcLang, transText, transLang); sent.Page = page; return sent;
    }
    public static Sentence insert(TradosDB db, int pageId, string name, string srcText, Langs srcLang, string transText, Langs transLang) {
...
namespace LMComLib {
  ...
  public static class TradosLib {
    ...
    public static void NormalizeLookupXml() {
      ...
      foreach (TradosDT.Sentence sent in db.Sentences) {
